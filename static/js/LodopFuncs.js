...
var downloadLodopVersion = null
window.isLodopJs = true
...
function getLodop(oOBJECT, oEMBED) {
    ...
    try {
        ...
        if (needCLodop()) {
            ...
            if (!LODOP) {
                downloadLodopVersion = {isUpdate: false, downloadUrl: 'CLodop_Setup_for_Win32NT'}
                // document.body.innerHTML = strCLodopInstall_1 + (CLodopIsLocal ? strCLodopInstall_2 : "") + strCLodopInstall_3 + document.body.innerHTML;                
                return;
            } else {
                if (CLODOP.CVERSION < "3.0.8.3") {
                    downloadLodopVersion = {isUpdate: true, downloadUrl: 'CLodop_Setup_for_Win32NT'}
            ...
            if ((!LODOP) || (!LODOP.VERSION)) {
                ...
                downloadLodopVersion = is64IE ? {isUpdate: false, downloadUrl: 'install_lodop64'} : {isUpdate: false, downloadUrl: 'install_lodop32'}
